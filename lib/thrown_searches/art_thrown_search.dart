...
import 'package:second_lfutter_project/details_pages/art_details_page.dart';
...
class MyArtSearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MyArtSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((artClass) => artClass.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((artClass) => artClass.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          artClassNotifier.currentArtClass = search[position];
