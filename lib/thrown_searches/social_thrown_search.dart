...
import 'package:second_lfutter_project/details_pages/social_details_page.dart';
...
class MySocialSearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MySocialSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((socialClass) => socialClass.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((socialClass) => socialClass.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          socialClassNotifier.currentSocialClass = search[position];
