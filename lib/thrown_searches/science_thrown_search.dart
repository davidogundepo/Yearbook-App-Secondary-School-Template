...
import 'package:second_lfutter_project/details_pages/science_details_page.dart';
...
class MyScienceSearch extends SearchDelegate {

  final List all;

  bool _isVisible = true;

  MyScienceSearch({@required this.all});
  ...
  Future navigateToScienceDetailsPage(context) async {
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((scienceClass) => scienceClass.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((scienceClass) => scienceClass.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          scienceClassNotifier.currentScienceClass = search[position];
                          navigateToScienceDetailsPage(context);
                        },
